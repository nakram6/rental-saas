          ...
          <div className={`rounded-2xl border shadow-sm ${panel}`}>
            <form onSubmit={submit} className="p-6 space-y-4">
              <div>
                ...
                <input className={input} value={data.name} onChange={(e) => setData("name", e.target.value)} placeholder="Customer name" />
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div>
                  ...
                  <input className={input} value={data.email} onChange={(e) => setData("email", e.target.value)} placeholder="email@example.com" />
                  {errors.email && <div className="text-sm text-red-600 mt-1">{errors.email}</div>}
                </div>

                <div>
                  <label className={`text-sm font-semibold ${pageText}`}>Phone</label>
                  <input className={input} value={data.phone} onChange={(e) => setData("phone", e.target.value)} placeholder="(519) 000-0000" />
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div>
                  ...
                  <input className={input} value={data.city} onChange={(e) => setData("city", e.target.value)} placeholder="Windsor" />
                </div>
              ...
              <div>
                ...
                <input className={input} value={data.address} onChange={(e) => setData("address", e.target.value)} placeholder="Street address" />
              </div>

              <div>
                <label className={`text-sm font-semibold ${pageText}`}>Notes</label>
                <textarea className={`${input} min-h-[110px]`} value={data.notes} onChange={(e) => setData("notes", e.target.value)} placeholder="Notes about this customer..." />
              </div>
